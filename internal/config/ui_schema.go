...
func UISchemaMap() map[string]interface{} {
	...
	providerProps := map[string]interface{}{
		...
		"api_base": strProp("API base URL", "Optional override of the default API base URL for this provider. Ignored for neuraldeep, which always uses https://api.neuraldeep.ru/v1. For codex it overrides the ChatGPT Codex backend (default https://chatgpt.com/backend-api/codex)."),
